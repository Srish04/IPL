...
select * from market_fact union
select * from cust_dimen union
select * from orders_dimen union
select * from shipping_dimen union
...
select profit from combined_table;
...
select count(unique(order_id)) from combined_table;
